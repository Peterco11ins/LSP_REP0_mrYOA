...
public class ETLPipeline {
    private static final String INPUT_PATH = "LSP__Project/data/products.csv";
    private static final String OUTPUT_PATH = "LSP__Project/data/transformed_products.csv";
